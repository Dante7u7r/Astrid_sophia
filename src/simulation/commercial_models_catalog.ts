...
export const COMMERCIAL_DIODES: Record<string, DiodeCommercialModel> = {
  ...
  "DB107": {
    name: "DB107",
    description: "Puente rectificador monofásico estándar (1000V, 1A, DIP-4)",
    is: 8.0e-9,
    rs: 0.045,
    n: 1.85,
    cjo: 25.0e-12,
  ...
  "W04M": {
    name: "W04M",
    description: "Puente rectificador de silicio miniatura (400V, 1.5A)",
    is: 1.2e-8,
    rs: 0.038,
    n: 1.80,
    cjo: 30.0e-12,
  ...
  "KBPC3510": {
    name: "KBPC3510",
    description: "Puente rectificador de potencia de alta corriente (1000V, 35A)",
    is: 5.0e-8,
    rs: 0.005,
    n: 1.90,
    cjo: 120.0e-12,
  ...
  "MB10S": {
    name: "MB10S",
    description: "Puente rectificador SMD ultra-compacto (1000V, 0.5A, SOIC-4)",
    is: 6.5e-9,
    rs: 0.085,
    n: 1.82,
    cjo: 18.0e-12,
