...
export const STANDARD_SERIES_E96 = [
...
/**
 * Ajusta cualquier valor físico al valor comercial normalizado más cercano en la serie E12, E24 o E96.
 * Funciona para cualquier orden de magnitud (p. ej. pF, nF, µF, Ω, kΩ, MΩ, µH, mH).
 */
export function snapToStandardValue(val: number, series: "E12" | "E24" | "E96" = "E24"): number {
  if (!Number.isFinite(val) || val <= 0) return val;

  const standardValues: readonly number[] = series === "E12"
    ? STANDARD_SERIES_E12
    : series === "E96"
      ? STANDARD_SERIES_E96
      : STANDARD_SERIES_E24;
